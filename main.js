...
const translations = {
  fr: {
    ...
    "about.p2":
      "J'ai développé deux projets concrets : <strong>G-360</strong>, une application de gestion commerciale pour PME, et <strong>La Conoscenza</strong>, un site web pour un centre de langue italienne basé à Brazzaville.",
    "about.p3":
    ...
    "p1.desc":
      "Application web complète dédiée aux PME pour centraliser leur gestion commerciale : suivi des clients, devis, factures, tableau de bord analytique et reporting. Conçue avec une architecture modulaire pour une maintenabilité optimale.",

    "p2.tag": "Site Web · Centre de langue",
    "p2.title": "La Conoscenza — Centre de langue italienne",
    "p2.desc":
      "Site vitrine complet pour un centre de langue italienne basé à Brazzaville, offrant des cours, des certifications CILS B2 et un accompagnement pour les universités italiennes. Design professionnel avec formulaire de contact et structure multipage.",
    ...
    "formation.school4":
      "Lycée Jean Baptiste Taty Loutard · Pointe-Noire, Congo",
  ...
  it: {
    ...
    "about.p2":
      "Ho sviluppato due progetti concreti: <strong>G-360</strong>, un'applicazione di gestione commerciale per PMI, e <strong>La Conoscenza</strong>, un sito web per un centro di lingua italiana a Brazzaville.",
    "about.p3":
    ...
    "p1.desc":
      "Applicazione web completa dedicata alle PMI per centralizzare la gestione commerciale: clienti, preventivi, fatture, dashboard analitica e reporting. Progettata con un'architettura modulare per una manutenibilità ottimale.",

    "p2.tag": "Sito Web · Centro linguistico",
    "p2.title": "La Conoscenza — Centro di lingua italiana",
    "p2.desc":
      "Sito vetrina completo per un centro di lingua italiana a Brazzaville, con corsi, certificazioni CILS B2 e supporto per le università italiane. Design professionale con modulo di contatto e struttura multipagina.",
    ...
    "formation.desc2":
      "Corso di laurea focalizzato sull'integrazione tra informatica e gestione aziendale, con competenze in sistemi informativi, gestione dei dati, analisi dei processi aziendali e sviluppo di soluzioni digitali.",
  ...
  en: {
    ...
    "about.p2":
      "I have developed two concrete projects: <strong>G-360</strong>, a commercial management app for SMEs, and <strong>La Conoscenza</strong>, a website for an Italian language centre in Brazzaville.",
    "about.p3":
    ...
    "p1.desc":
      "A complete web application for SMEs to centralise commercial management: client tracking, quotes, invoices, analytics dashboard and reporting. Built with a modular architecture for optimal maintainability.",

    "p2.tag": "Website · Language centre",
    "p2.title": "La Conoscenza — Italian Language Centre",
    "p2.desc":
      "A complete showcase website for an Italian language centre in Brazzaville, offering courses, CILS B2 certifications and support for Italian universities. Professional design with contact form and multipage structure.",
    ...
    "formation.desc2":
      "Versatile training covering IT fundamentals, project management, information systems and databases, with a business-oriented approach.",
